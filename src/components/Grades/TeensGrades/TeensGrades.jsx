...
const TeensGrades = () => {
  ...
  const onCalculateGrades = (name, value) => {
    ...
    currentGrades[name] = value * TEENS_GRADES[name];
  ...
  const onGenerateStudentPPT = async (data) => {
    const response = await fetch('/templates/teens_grades_report.pptx');
    ...
    <section className="main-section">
      <div className="wrapper">
        <form className="grades-form" onSubmit={onSubmitForm}>
          ...
          <div className="input-group">
            <div className="input-element">
              <label htmlFor="platform_01">Platform 01 (10%)</label>
              <input
                type="number"
                name="platform_01"
                id="platform_01"
          ...
          <div className="input-group">
            <div className="input-element">
              <label htmlFor="platform_02">Platform 02 (10%)</label>
              <input
                type="number"
                name="platform_02"
                id="platform_02"
