...
const GeneralGrades = () => {
  const {
    ...
    defaultValues: {
      ...
      student: '',
      teacher: '',
      date: formattedDate(new Date()), // <-- add current date as default date
      evidence_01: '',
      participation_01: '',
      midterm: '',
      project: '',
  ...
  const onCalculateGrades = (name, value) => {
    ...
    currentGrades[name] = Math.floor(value * GENERAL_GRADES[name]);
    ...
    <section className="main-section">
      <div className="wrapper">
        <form className="grades-form" onSubmit={onSubmitForm}>
          ...
          <div className="input-group">
            <div className="input-element">
              <label htmlFor="evidence_01">Evidence 01 (10%)</label>
              <input
                type="number"
                name="evidence_01"
                id="evidence_01"
                autoComplete="off"
                {...register('evidence_01', {
                  required: {
                    value: true,
              ...
              />
              {errors.evidence_01 && (
                <p className="form-error">{errors.evidence_01.message}</p>
              )}
            </div>
            <div className="input-element">
              <label htmlFor="participation_01">Participation 01 (10%)</label>
              <input
                type="number"
          ...
          <div className="input-group">
            ...
            <div className="input-element">
              <label htmlFor="project">Project (20%)</label>
              <input
                type="number"
                name="project"
                id="project"
          ...
          <div className="input-group">
            <div className="input-element">
              <label htmlFor="evidence_02">Evidence 02 (10%)</label>
              <input
                type="number"
                name="evidence_02"
                id="evidence_02"
                autoComplete="off"
                {...register('evidence_02', {
                  required: {
                    value: true,
                    message: 'This field is required',
                  },
              ...
              />
              {errors.evidence_02 && (
                <p className="form-error">{errors.evidence_02.message}</p>
              )}
            </div>
            <div className="input-element">
              <label htmlFor="participation_02">Participation 02 (10%)</label>
              <input
                type="number"
            ...
            <div className="input-element">
              <label htmlFor="final_exam">Final exam (20%)</label>
              <input
                type="number"
                name="final_exam"
                id="final_exam"
